    ...
    return (
        <div className="bg-gradient-to-b from-[#080b14] via-[#0d1022] to-[#15152b] flex items-center flex-col h-screen">
            <div className="text-white mt-auto mb-auto flex flex-col items-start text-left">
                ...
                <h3 className="text-[#c6c6c6] text-[2em]">EPITA student - Future Computer Engineer</h3>
                <a className="text-[#aaa9c5] text-[1.1em] mt-8 pr-[30%]">I'm a 19 years old french student in the engineering school <a class="link" href="https://www.epita.fr">EPITA</a> and I study computer science. I'm open to any opportunity.</a>
            ...
            <div className="z-[2]">
                <a href="#About me"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="220" fill="white" class="bi bi-arrow-down-circle-fill animate-bounce" viewBox="0 0 16 16">
